  ...
  return (
    <div className="relative group">
      ...
      <Link to={`/post/${post.id}`} className="block relative z-10">
        <div className="w-80 h-76 bg-[rgb(24,27,32)] border border-[rgb(84,90,106)] rounded-[20px] text-white flex flex-col p-5  transition-colors duration-300 group-hover:bg-gray-800">
          {/* header: avatar, title */}
